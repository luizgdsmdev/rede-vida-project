  ...
  return (
    <div className="w-full lg:w-5/12 xl:w-4/12 lg:pl-4">
        <div className="relative w-full aspect-[4/3] lg:aspect-square rounded-2xl overflow-hidden shadow-2xl group">
            ...
            <img alt="Professional healthcare worker preparing blood donation" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="Healthcare worker preparing equipment for blood donation" src="https://images.unsplash.com/photo-1615461066159-fea0960485d5?w=800&h=600&fit=crop&auto=format"/>
