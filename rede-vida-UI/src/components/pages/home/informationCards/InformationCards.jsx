    ...
    <section className="w-full bg-white dark:bg-background-dark py-12 px-6 lg:px-12">
        <div className="max-w-[1400px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <ScrollAnimation animation="fade-up" delay={100}>
                    <div className="group p-8 bg-background-light dark:bg-background-dark border-2 border-primary/20 rounded-2xl hover:border-primary transition-all hover:shadow-xl hover:-translate-y-1">
