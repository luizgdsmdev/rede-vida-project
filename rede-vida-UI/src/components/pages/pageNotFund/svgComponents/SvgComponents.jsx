...
function SvgComponents() {
  return (
    <div className="flex flex-row flex-wrap items-center justify-center relative max-w-2xl mx-auto h-[auto] w-full">
      <svg className="relative h-auto w-full max-w-[600px]" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 700 250">
        <defs>
          <filter id="glow">
        ...
        <g>
          <path 
            className={`stroke-primary stroke-[0.5rem] fill-transparent filter drop-shadow-[0_0_8px_rgba(255,138,122,0.5)] ${styles['svg-path-3']}`}
          ...
          />
          <path 
            className={`stroke-primary stroke-[0.5rem] fill-transparent filter drop-shadow-[0_0_8px_rgba(255,138,122,0.5)] ${styles['svg-path-2']}`}
          ...
          />
          <path 
            className={`stroke-primary stroke-[0.5rem] fill-transparent filter drop-shadow-[0_0_8px_rgba(255,138,122,0.5)] ${styles['svg-path-1']}`}
